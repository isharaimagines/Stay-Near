                    ...
                    <nav class="p-3 p-0 flex items-center justify-center">
                        ...
                        <div class="flex items-center justify-center text-lg">
                            <ul class="navlist flex items-center justify-center text-black font-semibold">
                                <li>
                                    <a href="./index.php" class="pr-4 hover:text-[#23CF6B]">Home</a>
                                </li>
                                <li>
                                    <a href="./room.php" class="pr-4 active hover:text-[#23CF6B]">Rooms</a>
                                </li>
                                <li>
            ...
            <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active relative">
                        <img class="w-full h-screen blur-[2px]" src="./img/locations_2.jpg" alt="Image" />
                        <div
